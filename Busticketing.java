...
public class Busticketing {
    ...
    for(int i=1;i<5;){
		...
		//store 20 seats every destination [1-10]//
    	for(int o=1; o<=10; o++){
    		available[o]=20;
  		}
    
    	//if user and password are correct proceed to MAIN MENU//
    	if(user.equals("Sandhya") && password.equals("1")){
    		...
    		for(int x=1; x==1;){
    			...
    			for(x=1; x==1;){
					...
					//if CHOICE is "1" display the DESTINATION//
    					...
    					System.out.println("***************************************");
						System.out.println("** 1.)Bangalore City   | Php600 |   "+available[1]+"   **");
    					System.out.println("** 2.)Mumbai City | Php170 |   "+available[2]+"   **");
    					System.out.println("** 3.) Kashmir | Php150 |   "+available[3]+"   **");
    					System.out.println("** 4.)Hyderbad       | Php200 |   "+available[4]+"   **");
    					System.out.println("** 5.)Goa      | Php250 |   "+available[5]+"   **");
    					System.out.println("** 6.)Mangalore      | Php350 |   "+available[6]+"   **");
    					System.out.println("** 7.)Bellary      | Php300 |   "+available[7]+"   **");
    					System.out.println("** 8.)Hubli      | Php450 |   "+available[8]+"   **");
    					System.out.println("** 9.)Mysore      | Php400 |   "+available[9]+"   **");
    					System.out.println("***************************************");
						System.out.println("***************************************\n");
					...
					//if CHOICE is "3" proceed to Ticket Booking//
    					...
    					if((available[1]==0)&&(available[2]==0)&&(available[3]==0)&&(available[4]==0)&&(available[5]==0)&&(available[6]==0)&&(available[7]==0)&&(available[8]==0)&&(available[9]==0)){
    					...
    					for(x=1; x==1;){
    						...
    						//if Inputed integers are "<1" or ">10", display error and go back to Inputing//
    						if(to<1 || to>10){
    					...
    					String dest[] = { " ", "Bangalore City", "Mumbai City", "Kashmir", "Hyderbad", "Goa","Mangalore","Bellary","Hubli","Mysore"};
    					double fare[] = { 0,600,170,150,200,250,350,300,450,400};
